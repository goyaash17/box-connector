...
public class BoxConnectorRestClientAdapter
    extends BoxConnectorOAuth2Adapter
    implements MuleContextAware, Disposable, Initialisable
{
    ...
    public BoxConnectorRestClientAdapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
        super(oauthManager);
    }
    ...
    public void getFileInfo(String file_id)
        throws IOException
    {
        HttpMethod method = null;
        method = new GetMethod();
        String uri = "https://api.box.com/2.0/files/{file_id}";
        uri = uri.replace("{file_id}", String.valueOf(file_id));
