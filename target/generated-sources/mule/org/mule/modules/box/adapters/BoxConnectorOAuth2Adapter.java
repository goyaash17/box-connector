...
import org.mule.modules.box.generated.adapters.BoxConnectorCapabilitiesAdapter;
import org.mule.modules.box.generated.adapters.BoxConnectorProcessAdapter;
...
/**
 * A {@code BoxConnectorOAuth2Adapter} is a wrapper around {@link BoxConnector } that adds OAuth capabilites to the pojo.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-20T10:50:27-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class BoxConnectorOAuth2Adapter
    extends BoxConnectorProcessAdapter
    implements OAuth2Adapter
{
    ...
    private final static Logger LOGGER = Logger.getLogger(BoxConnectorOAuth2Adapter.class);

    public BoxConnectorOAuth2Adapter(OAuth2Manager<OAuth2Adapter> oauthManager) {
