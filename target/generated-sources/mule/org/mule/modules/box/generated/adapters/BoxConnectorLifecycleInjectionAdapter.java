...
/**
 * A <code>BoxConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link BoxConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-09-20T10:50:27-07:00", comments = "Build UNNAMED.2793.f49b6c7")
public abstract class BoxConnectorLifecycleInjectionAdapter
    extends BoxConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(BoxConnectorLifecycleInjectionAdapter.class);
