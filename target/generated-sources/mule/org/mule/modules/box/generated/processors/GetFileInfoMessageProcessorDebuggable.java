...
public class GetFileInfoMessageProcessorDebuggable
    extends GetFileInfoMessageProcessor
    implements DebugInfoProvider
{


    public GetFileInfoMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("file_id", "File_id", (java.lang.String.class), file_id, muleEvent));
