...
public class BoxConnectorConnectorConfigConfigDefinitionParser
    extends AbstractDevkitBasedDefinitionParser
{

    private static Logger logger = LoggerFactory.getLogger(BoxConnectorConnectorConfigConfigDefinitionParser.class);
    ...
    public BeanDefinition parse(Element element, ParserContext parserContext) {
        ...
        setInitMethodIfNeeded(builder, (org.mule.modules.box.oauth.BoxConnectorOAuthManager.class));
        setDestroyMethodIfNeeded(builder, (org.mule.modules.box.oauth.BoxConnectorOAuthManager.class));
    ...
    private BeanDefinitionBuilder getBeanDefinitionBuilder(ParserContext parserContext) {
        try {
            return BeanDefinitionBuilder.rootBeanDefinition((org.mule.modules.box.oauth.BoxConnectorOAuthManager.class).getName());
            ...
            logger.error(("Cannot launch the mule app, the configuration [config-with-oauth] within the connector [box] is not supported in mule "+ muleVersion));
            throw new BeanDefinitionParsingException(new Problem(("Cannot launch the mule app, the configuration [config-with-oauth] within the connector [box] is not supported in mule "+ muleVersion), new Location(parserContext.getReaderContext().getResource()), null, noClassDefFoundError));
        }
    }
